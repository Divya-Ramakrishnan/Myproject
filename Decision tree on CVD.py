...
classifiers = {
    ...
    "Support Vector Machine": SVC(random_state=42, kernel='linear', C=1.0),  # Adjust C
    "Gradient Boosting": GradientBoostingClassifier(random_state=42, subsample=0.8)  # Adjust subsample
}
...
for name, classifier in classifiers.items():
    ...
    try:
        ...
        if name == "Decision Tree":
            ...
            print("Splitter:", classifier.splitter)
        ...
        # Interpretability: Decision Tree Feature Importance
        if name == "Decision Tree":
            ...
            print("Feature Importance for Decision Tree on Cardiovascular Disease Dataset:")
